...
export default function Page() {
  return (
    <section>
      ...
      <a className="project-pair svelte-ikj1jd" href="/projects#bore"><div className="text-black font-medium">Bore <svg width="18" height="18" stroke="currentColor" stroke-width="2" className="lucide-icon lucide lucide-arrow-up-right inline text-neutral-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg></div> <div><p style={{fontSize: '16px'}}>bypass your NAT in just 400 lines of code</p> <aside className="svelte-ikj1jd" style={{ color: '#737373', fontWeight: 400, fontSize: '16px'}}>6500+ stars on GitHub</aside></div> </a>
