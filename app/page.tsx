export default function Page() {
  return (
    <section>
      ...
      <div class="layout-md text-lg space-y-14"><div class="space-y-5">
      ...
      <p>I currently work as the COO of <a class="link" href="https://commonground.io/app">CommonGround</a>, a marketplace that connects farmers, landowners, and real estate professionals aimed at building the future of land transactions.</p> <p>My ambition is to build products that people love by sweating the details.</p> <p>To accomplish this, I am a generalist with a passion for end-to-end problem solving that marries<em class="svelte-ikj1jd"> system and interaction design</em>.
      ...
      </div> <div class="leading-snug space-y-4">
